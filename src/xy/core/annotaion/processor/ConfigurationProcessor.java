...
public class ConfigurationProcessor implements TypeProcessor {

	@Override
	public void obtainBeanDefinition(Class<?> clazz, BeanDefinition bi, BeanDefintionRegistry registry) {

		Configuration cAn = clazz.getAnnotation(Configuration.class);
		if (Objects.nonNull(cAn)) {
